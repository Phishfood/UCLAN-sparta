; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Dissertation Project\Dissertation Project\Import\Common\Utility.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?FirstDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z ; gen::FirstDelimitedSubstr
PUBLIC	?LastDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z ; gen::LastDelimitedSubstr
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\import\common\utility.cpp
;	COMDAT ?LastDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z
_TEXT	SEGMENT
$T1 = -212						; size = 4
_lastDelimiter$ = -8					; size = 4
___$ReturnUdt$ = 8					; size = 4
_sList$ = 12						; size = 4
_sDelimiter$ = 16					; size = 4
?LastDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z PROC ; gen::LastDelimitedSubstr, COMDAT
...
; 48   : 	string::size_type lastDelimiter = sList.find_last_of( sDelimiter );
	...
	push	eax
	mov	ecx, DWORD PTR _sDelimiter$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _sList$[ebp]
	call	?find_last_of@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIABV12@I@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::find_last_of
	mov	DWORD PTR _lastDelimiter$[ebp], eax

; 49   : 	if (lastDelimiter == string::npos)
	...
	jne	SHORT $LN2@LastDelimi

; 50   : 	{
; 51   : 		return sList;

	mov	eax, DWORD PTR _sList$[ebp]
	push	eax
...
; 54   : 	{
; 55   : 		return sList.substr( lastDelimiter + 1 );
...
; 57   : }
	...
	pop	ebp
	ret	0
?LastDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z ENDP ; gen::LastDelimitedSubstr
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\import\common\utility.cpp
;	COMDAT ?FirstDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z
_TEXT	SEGMENT
$T1 = -212						; size = 4
_firstDelimiter$ = -8					; size = 4
___$ReturnUdt$ = 8					; size = 4
_sList$ = 12						; size = 4
_sDelimiter$ = 16					; size = 4
?FirstDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z PROC ; gen::FirstDelimitedSubstr, COMDAT
...
; 30   : 	string::size_type firstDelimiter = sList.find_first_of( sDelimiter );

	push	0
	mov	eax, DWORD PTR _sDelimiter$[ebp]
	push	eax
	mov	ecx, DWORD PTR _sList$[ebp]
	...
	mov	DWORD PTR _firstDelimiter$[ebp], eax

; 31   : 	if (firstDelimiter == string::npos)

	mov	eax, DWORD PTR _firstDelimiter$[ebp]
	cmp	eax, DWORD PTR ?npos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@2IB ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::npos
	jne	SHORT $LN2@FirstDelim
...
; 36   : 	{
; 37   : 		return sList.substr( firstDelimiter - sDelimiter.length() + 1 );
	...
	mov	ecx, DWORD PTR _firstDelimiter$[ebp]
	sub	ecx, eax
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR ___$ReturnUdt$[ebp]
...
; 39   : }
	...
	pop	ebp
	ret	0
?FirstDelimitedSubstr@gen@@YA?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@ABV23@0@Z ENDP ; gen::FirstDelimitedSubstr
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI

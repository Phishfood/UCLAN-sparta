; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Dissertation Project\Dissertation Project\Import\Math\CMatrix2x2.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0HG@KODBMBDE@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
PUBLIC	??_C@_0HK@DIJNGMBA@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0HK@DIJNGMBA@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0HK@DIJNGMBA@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
	DB	'imon\documents\visual studio 2012\projects\dissertation proje'
	DB	'ct\dissertation project\import\math\cmatrix2x2.cpp', 00H ; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0HG@KODBMBDE@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0HG@KODBMBDE@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
	DB	'imon\documents\visual studio 2012\projects\dissertation proje'
	DB	'ct\dissertation project\import\math\cvector2.h', 00H ; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\import\math\cmatrix2x2.cpp
...
; 607  : 	GEN_ASSERT( !IsZero(det), "Singular matrix" );
	...
	add	eax, 7
	push	eax
	push	OFFSET ??_C@_0HK@DIJNGMBA@c?3?2users?2simon?2documents?2visual?5@
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\import\math\cmatrix2x2.h
...
; 54   : 	explicit CVector2( const TFloat32* pfElts )
...
; 57   : 		GEN_ASSERT_OPT( pfElts, "Invalid parameter" );
	...
	push	57					; 00000039H
	push	OFFSET ??_C@_0HG@KODBMBDE@c?3?2users?2simon?2documents?2visual?5@
	push	OFFSET ??_C@_0BC@DBAKKFEN@Invalid?5parameter?$AA@
	lea	ecx, DWORD PTR $T2[ebp]
	call	??0CFatalException@gen@@QAE@PBD0H@Z	; gen::CFatalException::CFatalException
	push	OFFSET __TI1?AVCFatalException@gen@@

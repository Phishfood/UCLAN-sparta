; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\UCLAN-sparta\Dissertation Project\Geometry.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?mpd3dDev@CGeometry@@0PAUID3D10Device@@A	; CGeometry::mpd3dDev
...
_BSS	SEGMENT
?mpd3dDev@CGeometry@@0PAUID3D10Device@@A DD 01H DUP (?)	; CGeometry::mpd3dDev
_BSS	ENDS
...
PUBLIC	??0CGeometry@@QAE@XZ				; CGeometry::CGeometry
PUBLIC	??0CGeometry@@QAE@UD3DXVECTOR3@@0M@Z		; CGeometry::CGeometry
PUBLIC	??1CGeometry@@QAE@XZ				; CGeometry::~CGeometry
PUBLIC	?CompareSource@CGeometry@@QAE_NQBD@Z		; CGeometry::CompareSource
PUBLIC	?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z ; CGeometry::Load
PUBLIC	?ReleaseResources@CGeometry@@QAEXXZ		; CGeometry::ReleaseResources
PUBLIC	?SetScale@CGeometry@@QAEXM@Z			; CGeometry::SetScale
PUBLIC	?UpdateMatrix@CGeometry@@QAEXXZ			; CGeometry::UpdateMatrix
PUBLIC	?Control@CGeometry@@QAEXMW4EKeyCode@@0000000@Z	; CGeometry::Control
PUBLIC	?Render@CGeometry@@QAEXPAUID3D10EffectTechnique@@@Z ; CGeometry::Render
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z$0
	DD	00H
	DD	FLAT:__unwindfunclet$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z$1
__ehfuncinfo$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z DD 019930522H
	DD	02H
	DD	FLAT:__unwindtable$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?Render@CGeometry@@QAEXPAUID3D10EffectTechnique@@@Z
_TEXT	SEGMENT
tv143 = -256						; size = 4
_p$1 = -56						; size = 4
...
_technique$ = 8						; size = 4
?Render@CGeometry@@QAEXPAUID3D10EffectTechnique@@@Z PROC ; CGeometry::Render, COMDAT
; _this$ = ecx
...
; 293  : 	// Don't render if no geometry
; 294  : 	if (!m_HasGeometry)
...
; 297  : 	}
; 298  : 
; 299  : 	// Don't redner without a technique. Causes odd problems. 
; 300  : 	if( technique == nullptr )
...
; 308  : 	}
; 309  : 
; 310  : 	// Select vertex and index buffer - assuming all data will be as triangle lists
; 311  : 	UINT offset = 0;

	mov	DWORD PTR _offset$[ebp], 0

; 312  : 	mpd3dDev->IASetVertexBuffers( 0, 1, &m_VertexBuffer, &m_VertexSize, &offset );

	mov	esi, esp
	lea	eax, DWORD PTR _offset$[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 2016				; 000007e0H
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	push	1
	push	0
	mov	eax, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
	push	edx
...
; 313  : 	mpd3dDev->IASetInputLayout( m_VertexLayout );
	...
	mov	ecx, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
	push	ecx
...
; 314  : 	mpd3dDev->IASetIndexBuffer( m_IndexBuffer, DXGI_FORMAT_R16_UINT, 0 );
...
; 315  : 	mpd3dDev->IASetPrimitiveTopology( D3D10_PRIMITIVE_TOPOLOGY_TRIANGLELIST );
...
; 316  : 
; 317  : 	// Render the model. All the data and shader variables are prepared, now select the technique to use and draw.
; 318  : 	// The loop is for advanced techniques that need multiple passes - we will only use techniques with one pass
; 319  : 	D3D10_TECHNIQUE_DESC techDesc;
; 320  : 	technique->GetDesc( &techDesc );
...
; 321  : 	for( UINT p = 0; p < techDesc.Passes; ++p )
...
; 322  : 	{
; 323  : 		technique->GetPassByIndex( p )->Apply( 0 );
...
; 324  : 		mpd3dDev->DrawIndexed( m_NumIndices, 0, 0 );

	mov	esi, esp
	push	0
	push	0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+2024]
	push	ecx
	mov	edx, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
...
; 326  : 	mpd3dDev->DrawIndexed( m_NumIndices, 0, 0 );
...
$LN9@Render:
	...
	DB	116					; 00000074H
	DB	0
?Render@CGeometry@@QAEXPAUID3D10EffectTechnique@@@Z ENDP ; CGeometry::Render
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?Control@CGeometry@@QAEXMW4EKeyCode@@0000000@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_frameTime$ = 8						; size = 4
_turnUp$ = 12						; size = 4
...
?Control@CGeometry@@QAEXMW4EKeyCode@@0000000@Z PROC	; CGeometry::Control, COMDAT
; _this$ = ecx
...
; 250  : 	{
; 251  : 		m_Rotation.x += RotSpeed * frameTime;
...
; 254  : 	{
; 255  : 		m_Rotation.x -= RotSpeed * frameTime;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+104]
	mulss	xmm0, DWORD PTR _frameTime$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+120]
	subss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+120], xmm1
$LN7@Control:

; 256  : 	}
; 257  : 	if (KeyHeld( turnRight ))
...
; 258  : 	{
; 259  : 		m_Rotation.y += RotSpeed * frameTime;
...
; 262  : 	{
; 263  : 		m_Rotation.y -= RotSpeed * frameTime;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+104]
	mulss	xmm0, DWORD PTR _frameTime$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+124]
	subss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+124], xmm1
$LN5@Control:

; 264  : 	}
; 265  : 	if (KeyHeld( turnCW ))
...
; 266  : 	{
; 267  : 		m_Rotation.z += RotSpeed * frameTime;
...
; 270  : 	{
; 271  : 		m_Rotation.z -= RotSpeed * frameTime;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR [eax+104]
	mulss	xmm0, DWORD PTR _frameTime$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [ecx+128]
	subss	xmm1, xmm0
	mov	edx, DWORD PTR _this$[ebp]
	movss	DWORD PTR [edx+128], xmm1
$LN3@Control:

; 272  : 	}
; 273  : 
; 274  : 	// Local Z movement - move in the direction of the Z axis, get axis from world matrix
; 275  : 	if (KeyHeld( moveForward ))
...
; 276  : 	{
; 277  : 		m_Position.x += m_WorldMatrix._31 * MoveSpeed * frameTime;
...
; 278  : 		m_Position.y += m_WorldMatrix._32 * MoveSpeed * frameTime;
...
; 279  : 		m_Position.z += m_WorldMatrix._33 * MoveSpeed * frameTime;
...
; 282  : 	{
; 283  : 		m_Position.x -= m_WorldMatrix._31 * MoveSpeed * frameTime;
	...
	mulss	xmm0, DWORD PTR _frameTime$[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	movss	xmm1, DWORD PTR [edx+108]
	subss	xmm1, xmm0
	mov	eax, DWORD PTR _this$[ebp]
	movss	DWORD PTR [eax+108], xmm1

; 284  : 		m_Position.y -= m_WorldMatrix._32 * MoveSpeed * frameTime;
...
; 285  : 		m_Position.z -= m_WorldMatrix._33 * MoveSpeed * frameTime;
...
; 287  : }
	...
	pop	ebp
	ret	36					; 00000024H
?Control@CGeometry@@QAEXMW4EKeyCode@@0000000@Z ENDP	; CGeometry::Control
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?UpdateMatrix@CGeometry@@QAEXXZ
_TEXT	SEGMENT
$T1 = -852						; size = 64
$T2 = -780						; size = 64
$T3 = -708						; size = 64
...
_this$ = -12						; size = 4
__$ArrayPad$ = -4					; size = 4
?UpdateMatrix@CGeometry@@QAEXXZ PROC			; CGeometry::UpdateMatrix, COMDAT
; _this$ = ecx
...
; 231  : 	// Make a matrix for position and scaling, and one each for X, Y & Z rotations
; 232  : 	D3DXMATRIX matrixXRot, matrixYRot, matrixZRot, matrixTranslation, matrixScaling;
...
; 233  : 	D3DXMatrixRotationX( &matrixXRot, m_Rotation.x );
...
; 234  : 	D3DXMatrixRotationY( &matrixYRot, m_Rotation.y );
...
; 235  : 	D3DXMatrixRotationZ( &matrixZRot, m_Rotation.z );
...
; 236  : 	D3DXMatrixTranslation( &matrixTranslation, m_Position.x, m_Position.y, m_Position.z );
...
; 237  : 	D3DXMatrixScaling( &matrixScaling, m_Scale.x, m_Scale.y, m_Scale.z );
...
; 238  : 
; 239  : 	// Multiply above matrices together to get the effect of them all combined - this makes the world matrix for the rendering pipeline
; 240  : 	// Order of multiplication is important, get slightly different control mechanism depending on order
; 241  : 	m_WorldMatrix = matrixScaling * matrixZRot * matrixXRot * matrixYRot * matrixTranslation;
...
$LN3@UpdateMatr:
	...
	DB	116					; 00000074H
	DB	0
?UpdateMatrix@CGeometry@@QAEXXZ ENDP			; CGeometry::UpdateMatrix
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.h
;	COMDAT ?SetScale@CGeometry@@QAEXM@Z
_TEXT	SEGMENT
$T1 = -220						; size = 12
_this$ = -8						; size = 4
_scale$ = 8						; size = 4
?SetScale@CGeometry@@QAEXM@Z PROC			; CGeometry::SetScale, COMDAT
; _this$ = ecx
...
; 109  : 		m_Scale = D3DXVECTOR3( scale, scale, scale );
...
; 110  : 	}
	...
	pop	ebp
	ret	4
?SetScale@CGeometry@@QAEXM@Z ENDP			; CGeometry::SetScale
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?ReleaseResources@CGeometry@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?ReleaseResources@CGeometry@@QAEXXZ PROC		; CGeometry::ReleaseResources, COMDAT
; _this$ = ecx
...
; 60   : 	SAFE_RELEASE( m_IndexBuffer );  // Using a DirectX helper macro to simplify code here - look it up in Defines.h
...
; 61   : 	SAFE_RELEASE( m_VertexBuffer );
...
; 62   : 	SAFE_RELEASE( m_VertexLayout );

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+2012], 0
...
; 64   : }
	...
	pop	ebp
	ret	0
?ReleaseResources@CGeometry@@QAEXXZ ENDP		; CGeometry::ReleaseResources
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z
_TEXT	SEGMENT
tv296 = -568						; size = 4
tv89 = -568						; size = 4
$T2 = -560						; size = 28
...
$T7 = -473						; size = 1
$T8 = -461						; size = 1
_initData$9 = -260					; size = 12
_bufferDesc$10 = -240					; size = 20
_PassDesc$11 = -212					; size = 40
_offset$12 = -164					; size = 4
_numElts$13 = -152					; size = 4
_subMesh$14 = -140					; size = 36
_mesh$15 = -96						; size = 52
_length$ = -36						; size = 4
_this$ = -24						; size = 4
...
_tangents$ = 16						; size = 1
?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z PROC ; CGeometry::Load, COMDAT
; _this$ = ecx
...
; 84   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 85   : 	UINT32 length = fileName.length();
...
; 89   : 	}
; 90   : 
; 91   : 	// Release any existing geometry in this object
; 92   : 	ReleaseResources();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?ReleaseResources@CGeometry@@QAEXXZ	; CGeometry::ReleaseResources

; 93   : 
; 94   : 
; 95   : 	if( fileName[length-1] == 'x' )
...
; 97   : 		//Load as X file
; 98   : 
; 99   : 		// Use CImportXFile class (from another application) to load the given file. The import code is wrapped in the namespace 'gen'
; 100  : 		gen::CImportXFile mesh;

	push	1
	lea	ecx, DWORD PTR _mesh$15[ebp]
	call	?__autoclassinit@CImportXFile@gen@@QAEXI@Z
	lea	ecx, DWORD PTR _mesh$15[ebp]
	call	??0CImportXFile@gen@@QAE@XZ		; gen::CImportXFile::CImportXFile
	mov	DWORD PTR __$EHRec$[ebp+8], 0

; 101  : 		if (mesh.ImportFile( fileName.c_str() ) != gen::kSuccess)
...
; 104  : 		}
; 105  : 
; 106  : 		// Get first sub-mesh from loaded file
; 107  : 		gen::SSubMesh subMesh;
; 108  : 		if (mesh.GetSubMesh( 0, &subMesh, tangents ) != gen::kSuccess)

	movzx	eax, BYTE PTR _tangents$[ebp]
	push	eax
	lea	ecx, DWORD PTR _subMesh$14[ebp]
	push	ecx
	push	0
	lea	ecx, DWORD PTR _mesh$15[ebp]
...
; 112  : 
; 113  : 
; 114  : 		// Create vertex element list & layout. We need a vertex layout to say what data we have per vertex in this model (e.g. position, normal, uv, etc.)
; 115  : 		// In previous projects the element list was a manually typed in array as we knew what data we would provide. However, as we can load models with
; 116  : 		// different vertex data this time we need flexible code. The array is built up one element at a time: ask the import class if it loaded normals, 
; 117  : 		// if so then add a normal line to the array, then ask if it loaded UVS...etc
; 118  : 		unsigned int numElts = 0;

	mov	DWORD PTR _numElts$13[ebp], 0

; 119  : 		unsigned int offset = 0;

	mov	DWORD PTR _offset$12[ebp], 0

; 120  : 		// Position is always required
; 121  : 		m_VertexElts[numElts].SemanticName = "POSITION";   // Semantic in HLSL (what is this data for)

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+220], OFFSET ??_C@_08JPMAAECC@POSITION?$AA@

; 122  : 		m_VertexElts[numElts].SemanticIndex = 0;           // Index to add to semantic (a count for this kind of data, when using multiple of the same type, e.g. TEXCOORD0, TEXCOORD1)

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+224], 0

; 123  : 		m_VertexElts[numElts].Format = DXGI_FORMAT_R32G32B32_FLOAT; // Type of data - this one will be a float3 in the shader. Most data communicated as though it were colours

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+228], 6

; 124  : 		m_VertexElts[numElts].AlignedByteOffset = offset;  // Offset of element from start of vertex data (e.g. if we have position (float3), uv (float2) then normal, the normal's offset is 5 floats = 5*4 = 20)

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _offset$12[ebp]
	mov	DWORD PTR [ecx+eax+236], edx

; 125  : 		m_VertexElts[numElts].InputSlot = 0;               // For when using multiple vertex buffers (e.g. instancing - an advanced topic)

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+232], 0

; 126  : 		m_VertexElts[numElts].InputSlotClass = D3D10_INPUT_PER_VERTEX_DATA; // Use this value for most cases (only changed for instancing)

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+240], 0

; 127  : 		m_VertexElts[numElts].InstanceDataStepRate = 0;                     // --"--

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+244], 0

; 128  : 		offset += 12;

	mov	eax, DWORD PTR _offset$12[ebp]
	add	eax, 12					; 0000000cH
	mov	DWORD PTR _offset$12[ebp], eax

; 129  : 		++numElts;

	mov	eax, DWORD PTR _numElts$13[ebp]
	add	eax, 1
	mov	DWORD PTR _numElts$13[ebp], eax

; 130  : 		// Repeat for each kind of vertex data
; 131  : 		if (subMesh.hasNormals)

	movzx	eax, BYTE PTR _subMesh$14[ebp+21]
	test	eax, eax
	je	$LN6@Load

; 132  : 		{
; 133  : 			m_VertexElts[numElts].SemanticName = "NORMAL";

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+220], OFFSET ??_C@_06IOJAGNKJ@NORMAL?$AA@

; 134  : 			m_VertexElts[numElts].SemanticIndex = 0;
...
; 135  : 			m_VertexElts[numElts].Format = DXGI_FORMAT_R32G32B32_FLOAT;
...
; 136  : 			m_VertexElts[numElts].AlignedByteOffset = offset;
...
; 137  : 			m_VertexElts[numElts].InputSlot = 0;
...
; 138  : 			m_VertexElts[numElts].InputSlotClass = D3D10_INPUT_PER_VERTEX_DATA;
...
; 139  : 			m_VertexElts[numElts].InstanceDataStepRate = 0;
...
; 142  : 		}
; 143  : 		if (subMesh.hasTangents)

	movzx	eax, BYTE PTR _subMesh$14[ebp+22]
	test	eax, eax
	je	$LN5@Load

; 144  : 		{
; 145  : 			m_VertexElts[numElts].SemanticName = "TANGENT";

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+220], OFFSET ??_C@_07HOFFNMLH@TANGENT?$AA@

; 146  : 			m_VertexElts[numElts].SemanticIndex = 0;
...
; 147  : 			m_VertexElts[numElts].Format = DXGI_FORMAT_R32G32B32_FLOAT;
...
; 148  : 			m_VertexElts[numElts].AlignedByteOffset = offset;
...
; 149  : 			m_VertexElts[numElts].InputSlot = 0;
...
; 150  : 			m_VertexElts[numElts].InputSlotClass = D3D10_INPUT_PER_VERTEX_DATA;
...
; 151  : 			m_VertexElts[numElts].InstanceDataStepRate = 0;
...
; 154  : 		}
; 155  : 		if (subMesh.hasTextureCoords)

	movzx	eax, BYTE PTR _subMesh$14[ebp+23]
	test	eax, eax
	je	$LN4@Load

; 156  : 		{
; 157  : 			m_VertexElts[numElts].SemanticName = "TEXCOORD";

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+220], OFFSET ??_C@_08CMDKBPJM@TEXCOORD?$AA@

; 158  : 			m_VertexElts[numElts].SemanticIndex = 0;
...
; 159  : 			m_VertexElts[numElts].Format = DXGI_FORMAT_R32G32_FLOAT;

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+228], 16		; 00000010H

; 160  : 			m_VertexElts[numElts].AlignedByteOffset = offset;
...
; 161  : 			m_VertexElts[numElts].InputSlot = 0;
...
; 162  : 			m_VertexElts[numElts].InputSlotClass = D3D10_INPUT_PER_VERTEX_DATA;
...
; 163  : 			m_VertexElts[numElts].InstanceDataStepRate = 0;
...
; 166  : 		}
; 167  : 		if (subMesh.hasVertexColours)

	movzx	eax, BYTE PTR _subMesh$14[ebp+24]
	test	eax, eax
	je	$LN3@Load

; 168  : 		{
; 169  : 			m_VertexElts[numElts].SemanticName = "COLOR";

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+220], OFFSET ??_C@_05DPNLPLKI@COLOR?$AA@

; 170  : 			m_VertexElts[numElts].SemanticIndex = 0;
...
; 171  : 			m_VertexElts[numElts].Format = DXGI_FORMAT_R8G8B8A8_UNORM; // A RGBA colour with 1 byte (0-255) per component

	mov	eax, DWORD PTR _numElts$13[ebp]
	imul	eax, 28					; 0000001cH
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+eax+228], 28		; 0000001cH

; 172  : 			m_VertexElts[numElts].AlignedByteOffset = offset;
...
; 173  : 			m_VertexElts[numElts].InputSlot = 0;
...
; 174  : 			m_VertexElts[numElts].InputSlotClass = D3D10_INPUT_PER_VERTEX_DATA;
...
; 175  : 			m_VertexElts[numElts].InstanceDataStepRate = 0;
...
; 178  : 		}
; 179  : 		m_VertexSize = offset;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _offset$12[ebp]
	mov	DWORD PTR [eax+2016], ecx

; 180  : 
; 181  : 		// Given the vertex element list, pass it to DirectX to create a vertex layout. We also need to pass an example of a technique that will
; 182  : 		// render this model. We will only be able to render this model with techniques that have the same vertex input as the example we use here
; 183  : 		D3D10_PASS_DESC PassDesc;
; 184  : 		exampleTechnique->GetPassByIndex( 0 )->GetDesc( &PassDesc );
	...
	mov	esi, esp
	lea	ecx, DWORD PTR _PassDesc$11[ebp]
	push	ecx
...
; 185  : 		mpd3dDev->CreateInputLayout( m_VertexElts, numElts, PassDesc.pIAInputSignature, PassDesc.IAInputSignatureSize, &m_VertexLayout );

	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 2012				; 000007dcH
	mov	esi, esp
	push	eax
	mov	ecx, DWORD PTR _PassDesc$11[ebp+12]
	push	ecx
	mov	edx, DWORD PTR _PassDesc$11[ebp+8]
	push	edx
	mov	eax, DWORD PTR _numElts$13[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 186  : 
; 187  : 
; 188  : 		// Create the vertex buffer and fill it with the loaded vertex data
; 189  : 		m_NumVertices = subMesh.numVertices;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _subMesh$14[ebp+8]
	mov	DWORD PTR [eax+216], ecx

; 190  : 		D3D10_BUFFER_DESC bufferDesc;
; 191  : 		bufferDesc.BindFlags = D3D10_BIND_VERTEX_BUFFER;

	mov	DWORD PTR _bufferDesc$10[ebp+8], 1

; 192  : 		bufferDesc.Usage = D3D10_USAGE_DEFAULT; // Not a dynamic buffer

	mov	DWORD PTR _bufferDesc$10[ebp+4], 0

; 193  : 		bufferDesc.ByteWidth = m_NumVertices * m_VertexSize; // Buffer size

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax+216]
	imul	edx, DWORD PTR [ecx+2016]
	mov	DWORD PTR _bufferDesc$10[ebp], edx

; 194  : 		bufferDesc.CPUAccessFlags = 0;   // Indicates that CPU won't access this buffer at all after creation

	mov	DWORD PTR _bufferDesc$10[ebp+12], 0

; 195  : 		bufferDesc.MiscFlags = 0;

	mov	DWORD PTR _bufferDesc$10[ebp+16], 0

; 196  : 		D3D10_SUBRESOURCE_DATA initData; // Initial data
; 197  : 		initData.pSysMem = subMesh.vertices;   

	mov	eax, DWORD PTR _subMesh$14[ebp+12]
	mov	DWORD PTR _initData$9[ebp], eax

; 198  : 		if (FAILED( mpd3dDev->CreateBuffer( &bufferDesc, &initData, &m_VertexBuffer )))

	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 212				; 000000d4H
	mov	esi, esp
	push	eax
	lea	ecx, DWORD PTR _initData$9[ebp]
	push	ecx
	lea	edx, DWORD PTR _bufferDesc$10[ebp]
	push	edx
	mov	eax, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR ?mpd3dDev@CGeometry@@0PAUID3D10Device@@A ; CGeometry::mpd3dDev
...
; 202  : 
; 203  : 
; 204  : 		// Create the index buffer - assuming 2-byte (WORD) index data
; 205  : 		m_NumIndices = static_cast<unsigned int>(subMesh.numFaces) * 3;

	mov	eax, DWORD PTR _subMesh$14[ebp+28]
	imul	eax, 3
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2024], eax

; 206  : 		bufferDesc.BindFlags = D3D10_BIND_INDEX_BUFFER;

	mov	DWORD PTR _bufferDesc$10[ebp+8], 2

; 207  : 		bufferDesc.Usage = D3D10_USAGE_DEFAULT;

	mov	DWORD PTR _bufferDesc$10[ebp+4], 0

; 208  : 		bufferDesc.ByteWidth = m_NumIndices * sizeof(WORD);

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+2024]
	shl	ecx, 1
	mov	DWORD PTR _bufferDesc$10[ebp], ecx

; 209  : 		bufferDesc.CPUAccessFlags = 0;

	mov	DWORD PTR _bufferDesc$10[ebp+12], 0

; 210  : 		bufferDesc.MiscFlags = 0;

	mov	DWORD PTR _bufferDesc$10[ebp+16], 0

; 211  : 		initData.pSysMem = subMesh.faces;   

	mov	eax, DWORD PTR _subMesh$14[ebp+32]
	mov	DWORD PTR _initData$9[ebp], eax

; 212  : 		if (FAILED( mpd3dDev->CreateBuffer( &bufferDesc, &initData, &m_IndexBuffer )))
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z$0:
	lea	ecx, DWORD PTR _mesh$15[ebp]
	jmp	??1CImportXFile@gen@@QAE@XZ
__unwindfunclet$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z$1:
	lea	ecx, DWORD PTR $T2[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
?Load@CGeometry@@QAE_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@PAUID3D10EffectTechnique@@_N@Z ENDP ; CGeometry::Load
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ?CompareSource@CGeometry@@QAE_NQBD@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_input$ = 8						; size = 4
?CompareSource@CGeometry@@QAE_NQBD@Z PROC		; CGeometry::CompareSource, COMDAT
; _this$ = ecx
...
; 20   : 	if( strcmp(input, sourceFile) == 0 )
	...
	add	esp, 8
	test	eax, eax
	jne	SHORT $LN1@CompareSou

; 21   : 	{
; 22   : 		return true;

	mov	al, 1
	jmp	SHORT $LN2@CompareSou
$LN1@CompareSou:
...
; 25   : }
	...
	pop	ebp
	ret	4
?CompareSource@CGeometry@@QAE_NQBD@Z ENDP		; CGeometry::CompareSource
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ??1CGeometry@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??1CGeometry@@QAE@XZ PROC				; CGeometry::~CGeometry, COMDAT
; _this$ = ecx
...
; 16   : }
	...
	pop	ebp
	ret	0
??1CGeometry@@QAE@XZ ENDP				; CGeometry::~CGeometry
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ??0CGeometry@@QAE@UD3DXVECTOR3@@0M@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_position$ = 8						; size = 12
_rotation$ = 20						; size = 12
_scale$ = 32						; size = 4
??0CGeometry@@QAE@UD3DXVECTOR3@@0M@Z PROC		; CGeometry::CGeometry, COMDAT
; _this$ = ecx
...
; 37   : 	SetScale( scale );
	...
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetScale@CGeometry@@QAEXM@Z		; CGeometry::SetScale

; 38   : 	UpdateMatrix();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?UpdateMatrix@CGeometry@@QAEXXZ		; CGeometry::UpdateMatrix

; 39   : 
; 40   : 	// Good practice to ensure all private data is sensibly initialised
; 41   : 	m_VertexBuffer = NULL;
...
; 43   : 	m_VertexSize = 0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2016], 0

; 44   : 	m_VertexLayout = NULL;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2012], 0

; 45   : 
; 46   : 	m_IndexBuffer = NULL;
...
; 47   : 	m_NumIndices = 0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2024], 0

; 48   : 
; 49   : 	m_HasGeometry = false;
...
; 53   : }
	...
	pop	ebp
	ret	28					; 0000001cH
??0CGeometry@@QAE@UD3DXVECTOR3@@0M@Z ENDP		; CGeometry::CGeometry
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\geometry.cpp
;	COMDAT ??0CGeometry@@QAE@XZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
??0CGeometry@@QAE@XZ PROC				; CGeometry::CGeometry, COMDAT
; _this$ = ecx
...
; 10   : }
	...
	pop	ebp
	ret	0
??0CGeometry@@QAE@XZ ENDP				; CGeometry::CGeometry
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\import\cimportxfile.h

; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\UCLAN-sparta\Dissertation Project\MapSquare.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ; MapSquare::MapSquare
PUBLIC	??1MapSquare@@QAE@XZ				; MapSquare::~MapSquare
PUBLIC	?FillWallInfluence@MapSquare@@QAEXHHH@Z		; MapSquare::FillWallInfluence
PUBLIC	?FillWallInfluenceRecurse@MapSquare@@QAEXHHH@Z	; MapSquare::FillWallInfluenceRecurse
...
PUBLIC	?CalcWallInfluence@MapSquare@@AAEXXZ		; MapSquare::CalcWallInfluence
...
__unwindtable$?LoadMap@MapSquare@@AAE_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z DD 0ffffffffH
	...
	DD	02H
	DD	FLAT:__unwindfunclet$?LoadMap@MapSquare@@AAE_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z$3
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z$0
__ehfuncinfo$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\mapsquare.cpp
;	COMDAT ?CalcWallInfluence@MapSquare@@AAEXXZ
_TEXT	SEGMENT
_j$1 = -32						; size = 4
_i$2 = -20						; size = 4
_this$ = -8						; size = 4
?CalcWallInfluence@MapSquare@@AAEXXZ PROC		; MapSquare::CalcWallInfluence, COMDAT
; _this$ = ecx
...
; 109  : 	for(int i = 0; i < mi_mapHeight; i++)
...
$LN7@CalcWallIn:
	...
	cmp	ecx, DWORD PTR [eax+262144]
	jae	SHORT $LN8@CalcWallIn

; 110  : 	{
; 111  : 		for(int j = 0; j < mi_mapWidth; j++)
...
$LN4@CalcWallIn:
	...
	cmp	ecx, DWORD PTR [eax+262148]
	jae	SHORT $LN2@CalcWallIn

; 112  : 		{
; 113  : 			if( mv_nodes[j][i]->cost == 0 )
...
; 114  : 			{
; 115  : 				FillWallInfluence(WALL_INFLUENCE_RANGE, j, i);
...
; 119  : }
	...
	pop	ebp
	ret	0
?CalcWallInfluence@MapSquare@@AAEXXZ ENDP		; MapSquare::CalcWallInfluence
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\mapsquare.cpp
...
; 49   : 	//create file streams and buffer string.
; 50   : 	std::ifstream mapFile;
...
; 51   : 	std::string buffer[MAX_MAP_SIZE];
...
; 52   : 
; 53   : 	//append expected filenames
; 54   : 	mapFile.open(mapName + ".txt");
...
; 55   : 
; 56   : 	//check files opened correctly. 
; 57   : 	if (mapFile.is_open())
...
; 60   : 		while (!mapFile.eof() && i < MAX_MAP_SIZE){
	...
	movzx	edx, al
	test	edx, edx
	jne	SHORT $LN7@LoadMap
	cmp	DWORD PTR _i$7[ebp], 256		; 00000100H
	jae	SHORT $LN7@LoadMap

; 61   : 			getline(mapFile, buffer[i]);
...
; 65   : 		mi_mapHeight = i;
	...
	mov	DWORD PTR [eax+262144], ecx

; 66   : 		mi_mapWidth = buffer[0].length();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+262148], eax

; 67   : 
; 68   : 		// allocate enough memory to hold all the nodes
; 69   : 		// this will crash and burn if the map isn't square.
; 70   : 		mp_memStart = (MapData*) malloc( sizeof(MapData) * mi_mapHeight * mi_mapWidth );

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262144]
	imul	ecx, 24					; 00000018H
	mov	edx, DWORD PTR _this$[ebp]
	imul	ecx, DWORD PTR [edx+262148]
	mov	esi, esp
	push	ecx
	...
	call	__RTC_CheckEsp
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+262152], eax

; 71   : 		mp_memNext = mp_memStart;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+262152]
	mov	DWORD PTR [eax+262156], edx

; 72   : 
; 73   : 		//convert to int - probably a neater way to do this
; 74   : 		for (UINT32 y = 0; y < mi_mapHeight; y++)

	mov	DWORD PTR _y$6[ebp], 0
	jmp	SHORT $LN6@LoadMap
$LN5@LoadMap:
...
; 75   : 		{
; 76   : 			for (int x = 0; x < mi_mapWidth; x++)
...
; 77   : 			{
; 78   : 				//add pointer to the array
; 79   : 				mv_nodes[x][y] = mp_memNext;
	...
	mov	ecx, DWORD PTR _y$6[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [edx+262156]
	mov	DWORD PTR [eax+ecx*4], edx

; 80   : 
; 81   : 				//initialise - not strictly needed, but safer. 
; 82   : 				mp_memNext->cost = buffer[y][x] - 48;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262156]
	mov	DWORD PTR [ecx], edx

; 83   : 				mp_memNext->heavyTurretInfluence = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262156]
	mov	DWORD PTR [ecx+16], 0

; 84   : 				mp_memNext->lightTurretInfluence = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262156]
	mov	DWORD PTR [ecx+8], 0

; 85   : 				mp_memNext->mediumTurretInfluence = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262156]
	mov	DWORD PTR [ecx+12], 0

; 86   : 				mp_memNext->wallInfluence = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+262156]
	mov	DWORD PTR [ecx+4], 0

; 87   : 				mp_memNext->pathInfluence = 0;
...
; 98   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN20@LoadMap
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
__unwindfunclet$?LoadMap@MapSquare@@AAE_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z$2:
	...
	call	??_M@YGXPAXIHP6EX0@Z@Z
	ret	0
__unwindfunclet$?LoadMap@MapSquare@@AAE_NV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z$3:
	lea	ecx, DWORD PTR $T4[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\mapsquare.cpp
;	COMDAT ?FillWallInfluenceRecurse@MapSquare@@QAEXHHH@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_range$ = 8						; size = 4
_x$ = 12						; size = 4
_y$ = 16						; size = 4
?FillWallInfluenceRecurse@MapSquare@@QAEXHHH@Z PROC	; MapSquare::FillWallInfluenceRecurse, COMDAT
; _this$ = ecx
...
; 45   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?FillWallInfluenceRecurse@MapSquare@@QAEXHHH@Z ENDP	; MapSquare::FillWallInfluenceRecurse
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\mapsquare.cpp
...
; 28   : 	for(int i = 0; i < mi_mapHeight; i++)
...
$LN7@FillWallIn:
	...
	cmp	ecx, DWORD PTR [eax+262144]
	jae	SHORT $LN8@FillWallIn

; 29   : 	{
; 30   : 		for(int j = 0; j < mi_mapWidth; j++)
...
; 31   : 		{
; 32   : 			// max alias decided to break horribly?
; 33   : 			int dist = ManhattanDistance( j, i, x, y );
...
; 34   : 			if( dist < 5 )
	...
	cmp	DWORD PTR _dist$1[ebp], 5
	jge	SHORT $LN1@FillWallIn

; 35   : 			{
; 36   : 				mv_nodes[i][j]->wallInfluence += 5 - dist;
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\dissertation project\mapsquare.cpp
;	COMDAT ??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
_TEXT	SEGMENT
tv85 = -232						; size = 4
$T2 = -224						; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
_fileName$ = 8						; size = 28
??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z PROC ; MapSquare::MapSquare, COMDAT
; _this$ = ecx
...
; 5    : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 6    : 	mi_mapWidth = 0;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+262148], 0

; 7    : 	mi_mapHeight = 0;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+262144], 0

; 8    : 	//throws an exception?
; 9    : 	/*mv_nodes.resize( start_size );
; 10   : 	for ( int i = 0; i < start_size; i++ )
; 11   : 	{
; 12   : 		mv_nodes[i].resize(start_size);
; 13   : 	}*/
; 14   : 
; 15   : 	LoadMap(fileName);
...
; 16   : 	CalcWallInfluence();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?CalcWallInfluence@MapSquare@@AAEXXZ	; MapSquare::CalcWallInfluence
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z$0:
	lea	ecx, DWORD PTR _fileName$[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z:
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [edx-236]
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z
	jmp	___CxxFrameHandler3
text$x	ENDS
??0MapSquare@@QAE@V?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z ENDP ; MapSquare::MapSquare
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\program files (x86)\microsoft visual studio 11.0\vc\include\fstream

; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Dissertation Project\Dissertation Project\Light.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?SetOrbit@CLight@@QAEXUD3DXVECTOR3@@MM@Z	; CLight::SetOrbit
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\light.cpp
...
; 102  : 	{
; 103  : 		mModel->SetPosition( mOrbitingPoint + D3DXVECTOR3(cos(mCumulativeTime * mOrbitSpeed)* mOrbitRadius, 0, sin(mCumulativeTime * mOrbitSpeed) * mOrbitRadius) );
...
; 107  : 	{
; 108  : 		mModel->SetPosition( mOrbiting->GetPosition() + D3DXVECTOR3(cos(mCumulativeTime * mOrbitSpeed)* mOrbitRadius, 0, sin(mCumulativeTime * mOrbitSpeed) * mOrbitRadius) );
...
; 112  : 	{
; 113  : 		float hue = fmodf(mCumulativeTime, mColourRate) / mColourRate;
	...
	movss	DWORD PTR _hue$6[ebp], xmm0

; 114  : 		fHSLToRGB( hue, 0.5f, 0.5f,mr, mg, mb);
	...
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _hue$6[ebp]
	movss	DWORD PTR [esp], xmm0
...
; 118  : 	{
; 119  : 		if( fmodf(mCumulativeTime, mPulseRate) < (mPulseRate / 2.0f) )
...
; 132  : 		{
; 133  : 			mBrightness -= mFadeRate * frameTime;
...
; 141  : 		{
; 142  : 			mBrightness += mFadeRate * frameTime;
...
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\light.cpp
;	COMDAT ?SetOrbit@CLight@@QAEXUD3DXVECTOR3@@MM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_point$ = 8						; size = 12
_radius$ = 20						; size = 4
_speed$ = 24						; size = 4
?SetOrbit@CLight@@QAEXUD3DXVECTOR3@@MM@Z PROC		; CLight::SetOrbit, COMDAT
; _this$ = ecx
...
; 48   : 	mOrbitingPoint = point;
	...
	mov	ecx, DWORD PTR _point$[ebp+8]
...
; 53   : }
	...
	pop	ebp
	ret	20					; 00000014H
?SetOrbit@CLight@@QAEXUD3DXVECTOR3@@MM@Z ENDP		; CLight::SetOrbit
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\light.cpp

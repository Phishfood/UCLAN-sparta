; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Dissertation Project\Dissertation Project\Import\Common\MSDefines.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0HL@LOKCAPBB@c?3?2users?2simon?2documents?2visual?5@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0HL@LOKCAPBB@c?3?2users?2simon?2documents?2visual?5@
CONST	SEGMENT
??_C@_0HL@LOKCAPBB@c?3?2users?2simon?2documents?2visual?5@ DB 'c:\users\s'
	DB	'imon\documents\visual studio 2012\projects\dissertation proje'
	DB	'ct\dissertation project\import\common\msdefines.cpp', 00H ; `string'
CONST	ENDS
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\import\common\msdefines.cpp
...
__catch$?SystemMessageBox@gen@@YA_NABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@0_N@Z$1:
	...
	push	eax
	push	OFFSET ??_C@_0BG@OGLJONGO@gen?3?3SystemMessageBox?$AA@
	push	OFFSET ??_C@_0HL@LOKCAPBB@c?3?2users?2simon?2documents?2visual?5@

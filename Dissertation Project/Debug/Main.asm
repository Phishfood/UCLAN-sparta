; Listing generated by Microsoft (R) Optimizing Compiler Version 17.00.61030.0 
	...
	TITLE	C:\Users\Simon\Documents\Visual Studio 2012\Projects\Dissertation Project\Dissertation Project\Main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?__autoclassinit@CScene@@QAEXI@Z		; CScene::__autoclassinit
PUBLIC	??_GCScene@@QAEPAXI@Z				; CScene::`scalar deleting destructor'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ??_GCScene@@QAEPAXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
___flags$ = 8						; size = 4
??_GCScene@@QAEPAXI@Z PROC				; CScene::`scalar deleting destructor', COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
...
$LN1@scalar:
	...
	pop	ebp
	ret	4
??_GCScene@@QAEPAXI@Z ENDP				; CScene::`scalar deleting destructor'
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
;	COMDAT ?__autoclassinit@CScene@@QAEXI@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_$initVBases$ = 8					; size = 4
?__autoclassinit@CScene@@QAEXI@Z PROC			; CScene::__autoclassinit, COMDAT
; _this$ = ecx
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	mov	DWORD PTR [eax], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+76020], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+76024], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+76120], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+76132], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100284], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100532], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100536], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100540], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100544], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100548], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100552], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100556], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100560], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100564], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100568], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100572], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100576], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100580], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100584], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100588], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100592], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100596], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100600], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100604], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100608], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+100612], 0
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	4
?__autoclassinit@CScene@@QAEXI@Z ENDP			; CScene::__autoclassinit
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\visual studio 2012\projects\dissertation project\dissertation project\main.cpp
;	COMDAT _wWinMain@16
_TEXT	SEGMENT
tv149 = -372						; size = 4
tv73 = -372						; size = 4
...
; 11   : 	CScene* myScene = new CScene();

	push	100624					; 00018910H
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T2[ebp], eax
	...
	call	?__autoclassinit@CScene@@QAEXI@Z
	mov	ecx, DWORD PTR $T2[ebp]
...
$LN11@wWinMain:
	...
	mov	DWORD PTR _myScene$[ebp], ecx

; 12   : 	// Initialise everything in turn
; 13   : 	if( !myScene->InitWindow( hInstance, nCmdShow) )

	mov	eax, DWORD PTR _nCmdShow$[ebp]
	push	eax
	mov	ecx, DWORD PTR _hInstance$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _myScene$[ebp]
...
; 16   : 	}
; 17   : 	if( !myScene->InitDevice() || !myScene->LoadEffectFile() || !myScene->InitScene() )
...
; 18   : 	{
; 19   : 		myScene->ReleaseResources(); // Cleanup DirectX on failure
...
; 21   : 	}
; 22   : 
; 23   : 	// Initialise simple input functions (in Input.h/.cpp, not part of DirectX)
; 24   : 	InitInput();

	call	?InitInput@@YAXXZ			; InitInput

; 25   : 
; 26   : 	// Initialise a timer class (in CTimer.h/.cpp, not part of DirectX). It's like a stopwatch - start it counting now
; 27   : 	CTimer Timer;
...
; 29   : 
; 30   : 	// Main message loop. The window will stay in this loop until it is closed
; 31   : 	MSG msg = {0};
...
; 32   : 	while( WM_QUIT != msg.message )

	cmp	DWORD PTR _msg$[ebp+4], 18		; 00000012H
	je	SHORT $LN3@wWinMain

; 33   : 	{
; 34   : 		// First check to see if there are any messages that need to be processed for the window (window resizing, minimizing, whatever), if there are then deal with them
; 35   : 		// If not then the window is idle and the D3D rendering occurs. This is in a loop. So the window is rendered over and over, as fast as possible as long as we are
; 36   : 		// not manipulating the window in some way
...
; 42   : 		}
; 43   : 		else // Otherwise render & update

	jmp	SHORT $LN1@wWinMain
$LN2@wWinMain:

; 44   : 		{
; 45   : 			myScene->RenderScene();

	mov	ecx, DWORD PTR _myScene$[ebp]
	call	?RenderScene@CScene@@QAEXXZ		; CScene::RenderScene

; 46   : 
; 47   : 			// Get the time passed since the last frame (since the last time this line was reached) - used so the rendering and update can be
; 48   : 			// synchronised to real time and won't be dependent on machine speed
; 49   : 			float frameTime = Timer.GetLapTime();

	lea	ecx, DWORD PTR _Timer$[ebp]
	call	?GetLapTime@CTimer@@QAEMXZ		; CTimer::GetLapTime
	fstp	DWORD PTR _frameTime$5[ebp]

; 50   : 			myScene->UpdateScene( frameTime );

	push	ecx
	movss	xmm0, DWORD PTR _frameTime$5[ebp]
...
; 53   : 
; 54   : 	// Release all the resources we've created before leaving
; 55   : 	myScene->ReleaseResources();
...
; 57   : 	delete myScene;
	...
	mov	eax, DWORD PTR _myScene$[ebp]
	mov	DWORD PTR $T4[ebp], eax
	mov	ecx, DWORD PTR $T4[ebp]
	mov	DWORD PTR $T3[ebp], ecx
	cmp	DWORD PTR $T3[ebp], 0
	je	SHORT $LN12@wWinMain
	push	1
	mov	ecx, DWORD PTR $T3[ebp]
	call	??_GCScene@@QAEPAXI@Z
	mov	DWORD PTR tv149[ebp], eax
	jmp	SHORT $LN13@wWinMain
$LN12@wWinMain:

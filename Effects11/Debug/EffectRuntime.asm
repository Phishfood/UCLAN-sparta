; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\UCLAN-sparta\Effects11\EffectRuntime.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0EA@LNFCJEEG@c?3?2users?2simon?2documents?2github?2@ ; `string'
...
PUBLIC	??_C@_0EJ@HLHONAJK@c?3?2users?2simon?2documents?2github?2@ ; `string'
...
_DATA	ENDS
;	COMDAT ??_C@_0EJ@HLHONAJK@c?3?2users?2simon?2documents?2github?2@
CONST	SEGMENT
??_C@_0EJ@HLHONAJK@c?3?2users?2simon?2documents?2github?2@ DB 'c:\users\s'
	DB	'imon\documents\github\uclan-sparta\effects11\effectruntime.cp'
	DB	'p', 00H					; `string'
CONST	ENDS
...
CONST	ENDS
;	COMDAT ??_C@_0EA@LNFCJEEG@c?3?2users?2simon?2documents?2github?2@
CONST	SEGMENT
??_C@_0EA@LNFCJEEG@c?3?2users?2simon?2documents?2github?2@ DB 'c:\users\s'
	DB	'imon\documents\github\uclan-sparta\effects11\effect.h', 00H ; `string'
CONST	ENDS
...
; File c:\users\simon\documents\github\uclan-sparta\effects11\effectruntime.cpp
...
; 431  :         D3DXASSERT( pBlock->InterfaceDepCount == 1 );
	...
	add	eax, 5
	push	eax
	push	OFFSET ??_C@_0EJ@HLHONAJK@c?3?2users?2simon?2documents?2github?2@
...
; 313  :         D3DXASSERT( BlockType == EBT_Rasterizer );
	...
	push	313					; 00000139H
	push	OFFSET ??_C@_0EA@LNFCJEEG@c?3?2users?2simon?2documents?2github?2@
	call	?D3DXDebugAssert@@YGHPBDH0@Z		; D3DXDebugAssert
$LN3@AsRasteriz:
	xor	eax, eax

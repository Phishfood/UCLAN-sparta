...
private:
	...
	bool mOrbitObject;
	CModel* mOrbiting;
	DirectX::XMFLOAT3 mOrbitingPoint;
	float mOrbitRadius;
	float mOrbitSpeed;
...
public:
	...
	DirectX::XMFLOAT3 GetColourV(){ return DirectX::XMFLOAT3( mr, mg, mb ); }
	...
	void SetOrbit(DirectX::XMFLOAT3 point, float radius, float speed);
	void StopOrbit();

...
// Reinterpret CVector2 as a DirectX::XMFLOAT2 - in various forms (const & ptr)
inline DirectX::XMFLOAT2& ToD3DXVECTOR( CVector2& v )
{
	return *reinterpret_cast<DirectX::XMFLOAT2*>(&v);
}

inline const DirectX::XMFLOAT2& ToD3DXVECTOR( const CVector2& v )
{
	return *reinterpret_cast<const DirectX::XMFLOAT2*>(&v);
}

inline DirectX::XMFLOAT2* ToD3DXVECTORPtr( CVector2* pV )
{
	return reinterpret_cast<DirectX::XMFLOAT2*>(pV);
}

inline const DirectX::XMFLOAT2* ToD3DXVECTORPtr( const CVector2* pV )
{
	return reinterpret_cast<const DirectX::XMFLOAT2*>(pV);
}


// Reinterpret a CVector3 as a DirectX::XMFLOAT3 - in various forms (const & ptr)
// Result can also be used as a D3DVECTOR (base class for DirectX::XMFLOAT3)
inline DirectX::XMFLOAT3& ToD3DXVECTOR( CVector3& v )
{
	return *reinterpret_cast<DirectX::XMFLOAT3*>(&v);
}

inline const DirectX::XMFLOAT3& ToD3DXVECTOR( const CVector3& v )
{
	return *reinterpret_cast<const DirectX::XMFLOAT3*>(&v);
}

inline DirectX::XMFLOAT3* ToD3DXVECTORPtr( CVector3* pV )
{
	return reinterpret_cast<DirectX::XMFLOAT3*>(pV);
}

inline const DirectX::XMFLOAT3* ToD3DXVECTORPtr( const CVector3* pV )
{
	return reinterpret_cast<const DirectX::XMFLOAT3*>(pV);
}


// Reinterpret a CVector4 as a DirectX::XMFLOAT4 - in various forms (const & ptr)
inline DirectX::XMFLOAT4& ToD3DXVECTOR( CVector4& v )
{
	return *reinterpret_cast<DirectX::XMFLOAT4*>(&v);
}

inline const DirectX::XMFLOAT4& ToD3DXVECTOR( const CVector4& v )
{
	return *reinterpret_cast<const DirectX::XMFLOAT4*>(&v);
}

inline DirectX::XMFLOAT4* ToD3DXVECTORPtr( CVector4* pV )
{
	return reinterpret_cast<DirectX::XMFLOAT4*>(pV);
}

inline const DirectX::XMFLOAT4* ToD3DXVECTORPtr( const CVector4* pV )
{
	return reinterpret_cast<const DirectX::XMFLOAT4*>(pV);
}

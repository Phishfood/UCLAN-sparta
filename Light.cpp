...
void CLight::SetOrbit(DirectX::XMFLOAT3 point, float radius, float speed)
{
...
void CLight::Update(float frameTime)
{
	...
	if( mOrbitPoint )
	{
		DirectX::XMFLOAT3 temp = DirectX::XMFLOAT3( cos(mCumulativeTime * mOrbitSpeed)* mOrbitRadius, 0, sin(mCumulativeTime * mOrbitSpeed) * mOrbitRadius);

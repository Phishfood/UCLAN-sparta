; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\Sparta2.0\UCLAN-sparta\Main.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?XMF3ToFloat3@@YA?AUV3@@UXMFLOAT3@DirectX@@@Z	; XMF3ToFloat3
...
PUBLIC	?SetSelf@CScene@@QAEXPAV1@@Z			; CScene::SetSelf
...
PUBLIC	??_C@_1GA@EGFBEFDK@?$AAE?$AAr?$AAr?$AAo?$AAr?$AA?5?$AAl?$AAo?$AAa?$AAd?$AAi?$AAn?$AAg?$AA?5?$AAS?$AAe?$AAt?$AAt?$AAi?$AAn?$AAg?$AAs?$AA?4?$AAi?$AAn?$AAi?$AA?0?$AA?5?$AAu?$AAn?$AAa?$AAb@ ; `string'
...
EXTRN	??0SettingsManager@@QAE@XZ:PROC			; SettingsManager::SettingsManager
EXTRN	?Load@SettingsManager@@QAE_NQA_W@Z:PROC		; SettingsManager::Load
EXTRN	??0CScene@@QAE@XZ:PROC				; CScene::CScene
EXTRN	??1CScene@@QAE@XZ:PROC				; CScene::~CScene
EXTRN	?InitDevice@CScene@@QAE_NXZ:PROC		; CScene::InitDevice
EXTRN	?ReleaseResources@CScene@@QAEXXZ:PROC		; CScene::ReleaseResources
EXTRN	?LoadEffectFile@CScene@@QAE_NXZ:PROC		; CScene::LoadEffectFile
EXTRN	?InitScene@CScene@@QAE_NXZ:PROC			; CScene::InitScene
EXTRN	?UpdateScene@CScene@@QAEXM@Z:PROC		; CScene::UpdateScene
EXTRN	?RenderScene@CScene@@QAEXXZ:PROC		; CScene::RenderScene
EXTRN	?InitWindow@CScene@@QAE_NPAUHINSTANCE__@@H@Z:PROC ; CScene::InitWindow
...
CONST	ENDS
;	COMDAT ??_C@_1GA@EGFBEFDK@?$AAE?$AAr?$AAr?$AAo?$AAr?$AA?5?$AAl?$AAo?$AAa?$AAd?$AAi?$AAn?$AAg?$AA?5?$AAS?$AAe?$AAt?$AAt?$AAi?$AAn?$AAg?$AAs?$AA?4?$AAi?$AAn?$AAi?$AA?0?$AA?5?$AAu?$AAn?$AAa?$AAb@
CONST	SEGMENT
??_C@_1GA@EGFBEFDK@?$AAE?$AAr?$AAr?$AAo?$AAr?$AA?5?$AAl?$AAo?$AAa?$AAd?$AAi?$AAn?$AAg?$AA?5?$AAS?$AAe?$AAt?$AAt?$AAi?$AAn?$AAg?$AAs?$AA?4?$AAi?$AAn?$AAi?$AA?0?$AA?5?$AAu?$AAn?$AAa?$AAb@ DB 'E'
	DB	00H, 'r', 00H, 'r', 00H, 'o', 00H, 'r', 00H, ' ', 00H, 'l', 00H
	DB	'o', 00H, 'a', 00H, 'd', 00H, 'i', 00H, 'n', 00H, 'g', 00H, ' '
	DB	00H, 'S', 00H, 'e', 00H, 't', 00H, 't', 00H, 'i', 00H, 'n', 00H
	DB	'g', 00H, 's', 00H, '.', 00H, 'i', 00H, 'n', 00H, 'i', 00H, ','
	DB	00H, ' ', 00H, 'u', 00H, 'n', 00H, 'a', 00H, 'b', 00H, 'l', 00H
	DB	'e', 00H, ' ', 00H, 't', 00H, 'o', 00H, ' ', 00H, 'c', 00H, 'o'
	DB	00H, 'n', 00H, 't', 00H, 'i', 00H, 'n', 00H, 'u', 00H, 'e', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\sparta2.0\uclan-sparta\scene.h
;	COMDAT ?SetSelf@CScene@@QAEXPAV1@@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_pointer$ = 8						; size = 4
?SetSelf@CScene@@QAEXPAV1@@Z PROC			; CScene::SetSelf, COMDAT
; _this$ = ecx

; 230  : 	void SetSelf(CScene* pointer){ mp_self = pointer; }
	...
	pop	ebp
	ret	4
?SetSelf@CScene@@QAEXPAV1@@Z ENDP			; CScene::SetSelf
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\sparta2.0\uclan-sparta\main.cpp
;	COMDAT ?XMF3ToFloat3@@YA?AUV3@@UXMFLOAT3@DirectX@@@Z
_TEXT	SEGMENT
_temp$ = -20						; size = 12
__$ArrayPad$ = -4					; size = 4
$T1 = 8							; size = 4
_in$ = 12						; size = 12
?XMF3ToFloat3@@YA?AUV3@@UXMFLOAT3@DirectX@@@Z PROC	; XMF3ToFloat3, COMDAT
...
; 15   : 		temp.y = in.y;
	...
	movss	xmm0, DWORD PTR _in$[ebp+4]
	movss	DWORD PTR _temp$[ebp+4], xmm0

; 16   : 		temp.z = in.z;

	movss	xmm0, DWORD PTR _in$[ebp+8]
	movss	DWORD PTR _temp$[ebp+8], xmm0
...
; 18   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN5@XMF3ToFloa
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
$LN3@XMF3ToFloa:
	...
	DB	112					; 00000070H
	DB	0
?XMF3ToFloat3@@YA?AUV3@@UXMFLOAT3@DirectX@@@Z ENDP	; XMF3ToFloat3
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
...
$T4 = -477864						; size = 4
$T5 = -477852						; size = 4
_frameTime$6 = -477648					; size = 4
_msg$ = -477636						; size = 28
_Timer$ = -477600					; size = 56
_myScene$ = -477536					; size = 477504
_mySettings$ = -12					; size = 4
__$ArrayPad$ = -4					; size = 4
_hInstance$ = 8						; size = 4
...
; 21   : {
	...
	mov	DWORD PTR [esp+4], ebp
	mov	ebp, esp
	mov	eax, 477912				; 00074ad8H
	call	__chkstk
	push	esi
	push	edi
	lea	edi, DWORD PTR [ebp-477912]
	mov	ecx, 119478				; 0001d2b6H
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	eax, DWORD PTR ___security_cookie
	xor	eax, ebp
...
; 22   : 	SettingsManager* mySettings = new SettingsManager();
	...
	je	SHORT $LN11@wWinMain
	mov	ecx, DWORD PTR $T2[ebp]
	call	??0SettingsManager@@QAE@XZ		; SettingsManager::SettingsManager
	mov	DWORD PTR tv71[ebp], eax
	jmp	SHORT $LN12@wWinMain
$LN11@wWinMain:
...
$LN12@wWinMain:
	...
	mov	DWORD PTR _mySettings$[ebp], ecx

; 23   : 	//Load in settings
; 24   : 	if (!mySettings->Load(L".\\Settings.ini"))

	push	OFFSET ??_C@_1BO@BODOBCGP@?$AA?4?$AA?2?$AAS?$AAe?$AAt?$AAt?$AAi?$AAn?$AAg?$AAs?$AA?4?$AAi?$AAn?$AAi?$AA?$AA@
	mov	ecx, DWORD PTR _mySettings$[ebp]
...
; 25   : 	{
; 26   : 		MessageBox(NULL, L"Error loading Settings.ini, unable to continue.", L"Error", MB_OK);

	mov	esi, esp
	push	0
	push	OFFSET ??_C@_1M@ILHOPKA@?$AAE?$AAr?$AAr?$AAo?$AAr?$AA?$AA@
	push	OFFSET ??_C@_1GA@EGFBEFDK@?$AAE?$AAr?$AAr?$AAo?$AAr?$AA?5?$AAl?$AAo?$AAa?$AAd?$AAi?$AAn?$AAg?$AA?5?$AAS?$AAe?$AAt?$AAt?$AAi?$AAn?$AAg?$AAs?$AA?4?$AAi?$AAn?$AAi?$AA?0?$AA?5?$AAu?$AAn?$AAa?$AAb@
	push	0
...
; 30   : 	CScene myScene;
	...
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	??0CScene@@QAE@XZ			; CScene::CScene

; 31   : 	myScene.SetSelf(&myScene);

	lea	eax, DWORD PTR _myScene$[ebp]
	push	eax
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?SetSelf@CScene@@QAEXPAV1@@Z		; CScene::SetSelf

; 32   : 	myScene.mySettings = mySettings;

	mov	eax, DWORD PTR _mySettings$[ebp]
	mov	DWORD PTR _myScene$[ebp], eax

; 33   : 	// Initialise everything in turn
; 34   : 	if( !myScene.InitWindow( hInstance, nCmdShow) )

	mov	eax, DWORD PTR _nCmdShow$[ebx]
	push	eax
	mov	ecx, DWORD PTR _hInstance$[ebx]
	push	ecx
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?InitWindow@CScene@@QAE_NPAUHINSTANCE__@@H@Z ; CScene::InitWindow
	movzx	edx, al
	test	edx, edx
...
; 36   : 		return 0;
	...
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	??1CScene@@QAE@XZ			; CScene::~CScene
	mov	eax, DWORD PTR $T3[ebp]
	jmp	$LN9@wWinMain
$LN7@wWinMain:

; 37   : 	}
; 38   : 	if( !myScene.InitDevice() || !myScene.LoadEffectFile() || !myScene.InitScene() )

	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?InitDevice@CScene@@QAE_NXZ		; CScene::InitDevice
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN5@wWinMain
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?LoadEffectFile@CScene@@QAE_NXZ		; CScene::LoadEffectFile
	movzx	eax, al
	test	eax, eax
	je	SHORT $LN5@wWinMain
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?InitScene@CScene@@QAE_NXZ		; CScene::InitScene
	movzx	eax, al
	test	eax, eax
	jne	SHORT $LN6@wWinMain
$LN5@wWinMain:

; 39   : 	{
; 40   : 		myScene.ReleaseResources(); // Cleanup DirectX on failure

	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?ReleaseResources@CScene@@QAEXXZ	; CScene::ReleaseResources
...
; 42   : 	}
; 43   : 
; 44   : 	// Initialise simple input functions (in Input.h/.cpp, not part of DirectX)
; 45   : 	InitInput();

	call	?InitInput@@YAXXZ			; InitInput

; 46   : 
; 47   : 	// Initialise a timer class (in CTimer.h/.cpp, not part of DirectX). It's like a stopwatch - start it counting now
; 48   : 	CTimer Timer;
...
; 50   : 
; 51   : 	// Main message loop. The window will stay in this loop until it is closed
; 52   : 	MSG msg = {0};
...
; 54   : 	{
; 55   : 		// First check to see if there are any messages that need to be processed for the window (window resizing, minimizing, whatever), if there are then deal with them
; 56   : 		// If not then the window is idle and the D3D rendering occurs. This is in a loop. So the window is rendered over and over, as fast as possible as long as we are
; 57   : 		// not manipulating the window in some way
...
; 63   : 		}
; 64   : 		else // Otherwise render & update

	jmp	SHORT $LN1@wWinMain
$LN2@wWinMain:

; 65   : 		{
; 66   : 			myScene.RenderScene();

	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?RenderScene@CScene@@QAEXXZ		; CScene::RenderScene

; 67   : 
; 68   : 			// Get the time passed since the last frame (since the last time this line was reached) - used so the rendering and update can be
; 69   : 			// synchronised to real time and won't be dependent on machine speed
; 70   : 			float frameTime = Timer.GetLapTime();

	lea	ecx, DWORD PTR _Timer$[ebp]
	call	?GetLapTime@CTimer@@QAEMXZ		; CTimer::GetLapTime
	fstp	DWORD PTR _frameTime$6[ebp]

; 71   : 			myScene.UpdateScene( frameTime );

	push	ecx
	movss	xmm0, DWORD PTR _frameTime$6[ebp]
	movss	DWORD PTR [esp], xmm0
	lea	ecx, DWORD PTR _myScene$[ebp]
	call	?UpdateScene@CScene@@QAEXM@Z		; CScene::UpdateScene
$LN1@wWinMain:
...
; 74   : 
; 75   : 	// Release all the resources we've created before leaving
; 76   : 	myScene.ReleaseResources();
...
; 81   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN17@wWinMain
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi

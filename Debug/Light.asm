; Listing generated by Microsoft (R) Optimizing Compiler Version 18.00.30501.0 
	...
	TITLE	C:\Users\Simon\Documents\GitHub\UCLAN-sparta\Light.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??1CLight@@QAE@XZ				; CLight::~CLight
PUBLIC	?SetColour@CLight@@QAEXMMM@Z			; CLight::SetColour
PUBLIC	?SetColour@CLight@@QAEXHHH@Z			; CLight::SetColour
PUBLIC	?SetOrbit@CLight@@QAEXPAVCModel@@MM@Z		; CLight::SetOrbit
PUBLIC	?SetOrbit@CLight@@QAEXUXMFLOAT3@DirectX@@MM@Z	; CLight::SetOrbit
PUBLIC	?StopOrbit@CLight@@QAEXXZ			; CLight::StopOrbit
PUBLIC	?SetColourCycle@CLight@@QAEXM@Z			; CLight::SetColourCycle
PUBLIC	?StopColourCycle@CLight@@QAEXXZ			; CLight::StopColourCycle
PUBLIC	?SetPulse@CLight@@QAEXM@Z			; CLight::SetPulse
PUBLIC	?StopPulse@CLight@@QAEXXZ			; CLight::StopPulse
PUBLIC	?SetFade@CLight@@QAEXM@Z			; CLight::SetFade
PUBLIC	?StopFade@CLight@@QAEXXZ			; CLight::StopFade
PUBLIC	?Update@CLight@@QAEXM@Z				; CLight::Update
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?Update@CLight@@QAEXM@Z
_TEXT	SEGMENT
tv318 = -324						; size = 4
tv279 = -324						; size = 4
tv409 = -320						; size = 4
...
_this$ = -8						; size = 4
_frameTime$ = 8						; size = 4
?Update@CLight@@QAEXM@Z PROC				; CLight::Update, COMDAT
; _this$ = ecx
...
; 102  : 	{
; 103  : 		DirectX::XMFLOAT3 temp = DirectX::XMFLOAT3( cos(mCumulativeTime * mOrbitSpeed)* mOrbitRadius, 0, sin(mCumulativeTime * mOrbitSpeed) * mOrbitRadius);
...
; 104  : 		temp.x += mOrbitingPoint.x;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _temp$6[ebp]
	addss	xmm0, DWORD PTR [eax+40]
	movss	DWORD PTR _temp$6[ebp], xmm0

; 105  : 		temp.y += mOrbitingPoint.y;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _temp$6[ebp+4]
	addss	xmm0, DWORD PTR [eax+44]
	movss	DWORD PTR _temp$6[ebp+4], xmm0

; 106  : 		temp.z += mOrbitingPoint.z;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _temp$6[ebp+8]
	addss	xmm0, DWORD PTR [eax+48]
	movss	DWORD PTR _temp$6[ebp+8], xmm0

; 107  : 		mModel->SetPosition( temp );

	sub	esp, 12					; 0000000cH
	mov	eax, esp
	mov	ecx, DWORD PTR _temp$6[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _temp$6[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _temp$6[ebp+8]
...
; 111  : 	{
; 112  : 		DirectX::XMFLOAT3 temp = DirectX::XMFLOAT3(cos(mCumulativeTime * mOrbitSpeed)* mOrbitRadius, 0, sin(mCumulativeTime * mOrbitSpeed) * mOrbitRadius);
...
; 113  : 		temp.x +=  mOrbiting->GetPosition().x;
...
; 114  : 		temp.y +=  mOrbiting->GetPosition().y;
	...
	mov	ecx, DWORD PTR [ecx+36]
	call	?GetPosition@CModel@@QAE?AUXMFLOAT3@DirectX@@XZ ; CModel::GetPosition
	movss	xmm0, DWORD PTR _temp$5[ebp+4]
	addss	xmm0, DWORD PTR [eax+4]
	movss	DWORD PTR _temp$5[ebp+4], xmm0

; 115  : 		temp.z +=  mOrbiting->GetPosition().z;
	...
	mov	ecx, DWORD PTR [ecx+36]
	call	?GetPosition@CModel@@QAE?AUXMFLOAT3@DirectX@@XZ ; CModel::GetPosition
	movss	xmm0, DWORD PTR _temp$5[ebp+8]
	addss	xmm0, DWORD PTR [eax+8]
	movss	DWORD PTR _temp$5[ebp+8], xmm0

; 116  : 		mModel->SetPosition( temp );

	sub	esp, 12					; 0000000cH
	mov	eax, esp
	mov	ecx, DWORD PTR _temp$5[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _temp$5[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _temp$5[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx]
	call	?SetPosition@CModel@@QAEXUXMFLOAT3@DirectX@@@Z ; CModel::SetPosition
...
; 120  : 	{
; 121  : 		float hue = fmodf(mCumulativeTime, mColourRate) / mColourRate;
	...
	mov	edx, DWORD PTR _this$[ebp]
	divss	xmm0, DWORD PTR [edx+64]
	movss	DWORD PTR _hue$4[ebp], xmm0

; 122  : 		fHSLToRGB( hue, 0.5f, 0.5f,mr, mg, mb);
	...
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _hue$4[ebp]
	movss	DWORD PTR [esp], xmm0
...
; 126  : 	{
; 127  : 		if( fmodf(mCumulativeTime, mPulseRate) < (mPulseRate / 2.0f) )
	...
	comiss	xmm0, DWORD PTR tv409[ebp]
	jbe	SHORT $LN8@Update

; 128  : 		{
; 129  : 			mBrightness = 0.0f;
...
; 140  : 		{
; 141  : 			mBrightness -= mFadeRate * frameTime;
...
; 149  : 		{
; 150  : 			mBrightness += mFadeRate * frameTime;
...
; 160  : 	{
; 161  : 		mr = (rand() % 256) / 255.0f;

	call	_rand
	and	eax, -2147483393			; 800000ffH
	jns	SHORT $LN19@Update
	dec	eax
...
; 162  : 		mg = (rand() % 256) / 255.0f;

	call	_rand
	and	eax, -2147483393			; 800000ffH
	jns	SHORT $LN20@Update
	dec	eax
	or	eax, -256				; ffffff00H
	inc	eax
$LN20@Update:
...
; 163  : 		mb = (rand() % 256) / 255.0f;

	call	_rand
	and	eax, -2147483393			; 800000ffH
	jns	SHORT $LN21@Update
	dec	eax
	or	eax, -256				; ffffff00H
	inc	eax
$LN21@Update:
...
$LN15@Update:
	...
	DB	112					; 00000070H
	DB	0
?Update@CLight@@QAEXM@Z ENDP				; CLight::Update
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?StopFade@CLight@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?StopFade@CLight@@QAEXXZ PROC				; CLight::StopFade, COMDAT
; _this$ = ecx
...
; 96   : }
	...
	pop	ebp
	ret	0
?StopFade@CLight@@QAEXXZ ENDP				; CLight::StopFade
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetFade@CLight@@QAEXM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_rate$ = 8						; size = 4
?SetFade@CLight@@QAEXM@Z PROC				; CLight::SetFade, COMDAT
; _this$ = ecx
...
; 91   : }
	...
	pop	ebp
	ret	4
?SetFade@CLight@@QAEXM@Z ENDP				; CLight::SetFade
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?StopPulse@CLight@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?StopPulse@CLight@@QAEXXZ PROC				; CLight::StopPulse, COMDAT
; _this$ = ecx
...
; 82   : }
	...
	pop	ebp
	ret	0
?StopPulse@CLight@@QAEXXZ ENDP				; CLight::StopPulse
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetPulse@CLight@@QAEXM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_rate$ = 8						; size = 4
?SetPulse@CLight@@QAEXM@Z PROC				; CLight::SetPulse, COMDAT
; _this$ = ecx
...
; 77   : }
	...
	pop	ebp
	ret	4
?SetPulse@CLight@@QAEXM@Z ENDP				; CLight::SetPulse
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?StopColourCycle@CLight@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?StopColourCycle@CLight@@QAEXXZ PROC			; CLight::StopColourCycle, COMDAT
; _this$ = ecx
...
; 70   : }
	...
	pop	ebp
	ret	0
?StopColourCycle@CLight@@QAEXXZ ENDP			; CLight::StopColourCycle
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetColourCycle@CLight@@QAEXM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_rate$ = 8						; size = 4
?SetColourCycle@CLight@@QAEXM@Z PROC			; CLight::SetColourCycle, COMDAT
; _this$ = ecx
...
; 65   : }
	...
	pop	ebp
	ret	4
?SetColourCycle@CLight@@QAEXM@Z ENDP			; CLight::SetColourCycle
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?StopOrbit@CLight@@QAEXXZ
_TEXT	SEGMENT
_this$ = -8						; size = 4
?StopOrbit@CLight@@QAEXXZ PROC				; CLight::StopOrbit, COMDAT
; _this$ = ecx
...
; 57   : 	mOrbitObject = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+33], 0

; 58   : 	mOrbitPoint = false;
...
; 59   : }
	...
	pop	ebp
	ret	0
?StopOrbit@CLight@@QAEXXZ ENDP				; CLight::StopOrbit
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetOrbit@CLight@@QAEXUXMFLOAT3@DirectX@@MM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_point$ = 8						; size = 12
_radius$ = 20						; size = 4
_speed$ = 24						; size = 4
?SetOrbit@CLight@@QAEXUXMFLOAT3@DirectX@@MM@Z PROC	; CLight::SetOrbit, COMDAT
; _this$ = ecx
...
; 53   : }
	...
	pop	ebp
	ret	20					; 00000014H
?SetOrbit@CLight@@QAEXUXMFLOAT3@DirectX@@MM@Z ENDP	; CLight::SetOrbit
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetOrbit@CLight@@QAEXPAVCModel@@MM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_model$ = 8						; size = 4
_radius$ = 12						; size = 4
_speed$ = 16						; size = 4
?SetOrbit@CLight@@QAEXPAVCModel@@MM@Z PROC		; CLight::SetOrbit, COMDAT
; _this$ = ecx
...
; 40   : 	mOrbitRadius = radius;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _radius$[ebp]
	movss	DWORD PTR [eax+52], xmm0

; 41   : 	mOrbitSpeed = speed;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR _speed$[ebp]
	movss	DWORD PTR [eax+56], xmm0

; 42   : 	mOrbitPoint = false;

	mov	eax, DWORD PTR _this$[ebp]
	mov	BYTE PTR [eax+32], 0

; 43   : 	mOrbitObject = true;
...
; 44   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?SetOrbit@CLight@@QAEXPAVCModel@@MM@Z ENDP		; CLight::SetOrbit
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetColour@CLight@@QAEXHHH@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_red$ = 8						; size = 4
_green$ = 12						; size = 4
_blue$ = 16						; size = 4
?SetColour@CLight@@QAEXHHH@Z PROC			; CLight::SetColour, COMDAT
; _this$ = ecx
...
; 34   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?SetColour@CLight@@QAEXHHH@Z ENDP			; CLight::SetColour
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
;	COMDAT ?SetColour@CLight@@QAEXMMM@Z
_TEXT	SEGMENT
_this$ = -8						; size = 4
_red$ = 8						; size = 4
_green$ = 12						; size = 4
_blue$ = 16						; size = 4
?SetColour@CLight@@QAEXMMM@Z PROC			; CLight::SetColour, COMDAT
; _this$ = ecx
...
; 27   : }
	...
	pop	ebp
	ret	12					; 0000000cH
?SetColour@CLight@@QAEXMMM@Z ENDP			; CLight::SetColour
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
...
$T2 = -212						; size = 4
_this$ = -8						; size = 4
??1CLight@@QAE@XZ PROC					; CLight::~CLight, COMDAT
; _this$ = ecx
...
; 20   : }
	...
	pop	ebp
	ret	0
??1CLight@@QAE@XZ ENDP					; CLight::~CLight
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File c:\users\simon\documents\github\uclan-sparta\light.cpp
...
; 7    : 	mCumulativeTime = 0.0f;

	mov	eax, DWORD PTR _this$[ebp]
	movss	xmm0, DWORD PTR __real@00000000
	movss	DWORD PTR [eax+28], xmm0

; 8    : 	mOrbitObject = false;
